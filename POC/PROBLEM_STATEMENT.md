...
Use the provided dataset package d2c churn data package folder. The snapshot date and target definition are given in the data dictionary.
...
Submit exactly four folders in this repo:
...
# Part_1 — Data Audit, EDA & Business Understanding
...
# Part_2 — RFM Segmentation & Retention Strategy
...
# Part_3 — Churn Prediction Model & Model Card
...
# Part_4 — FastAPI Churn Scoring Service & Reproducible ML Workflow
